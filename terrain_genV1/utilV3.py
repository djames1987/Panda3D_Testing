...
class Octree:
    ...
    def add_data(self, voxel):
        x, y, z = voxel['position']
        data = (voxel['type'], voxel['touching_air'])
        node = self.root
        ...
        node.data = (x, y, z, data)  # Update the voxel data with x, y, z
